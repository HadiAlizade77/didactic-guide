...
{
 $add_save_button='<button class="btn btn-primary me-2" type="submit" onclick=set_action("experience_add")>Add New Experience</button> <button class="btn btn-outline-secondary px-4 me-2" type="submit" onclick=set_action("experience_add_next")>Save & Next</button>';//tep_image_submit(PATH_TO_BUTTON.'add_new_experience.gif', IMAGE_SAVE_ADD_NEW," onclick=set_action('experience_add')")."&nbsp;&nbsp;&nbsp;".tep_image_submit(PATH_TO_BUTTON.'button_save_next.gif', IMAGE_SAVE_NEXT,"onclick=set_action('experience_add_next')");
...
if($error)
{
 ...
 $reference_button='<button class="btn btn-primary me-2" type="submit" onclick=set_action1("reference_add")>Add New Experience</button> <button class="btn btn-outline-secondary px-4 me-2" type="submit" onclick=set_action1("reference_add_next")>Save & Next</button>';//tep_image_submit(PATH_TO_BUTTON.'button_save_next.gif', IMAGE_SAVE_NEXT,"onclick=set_action1('reference_add_next')")." ".tep_image_submit(PATH_TO_BUTTON.'button_save_add_new.gif', IMAGE_SAVE_ADD_NEW," onclick=set_action1('reference_add')");
 ...
 if($_POST['action']=="edit" || $_POST['action']=="experience_add_next")
  ...
  if($_POST['action']=="edit")
  {
   ...
   $add_next_button     = "<a  href='".tep_href_link(FILENAME_JOBSEEKER_RESUME2."?query_string=".$query_string)."' class='btn btn-outline-secondary px-4 me-2'>".tep_db_output(INFO_SKIP_THIS_STEP)."</a>";
