...
if ($no_of_job > 0) {
	...
	$graph = '<div class="col-md-5">
	<div class="card card-jobseeker mb-3">
                <div class="card-body p-0">
				<h4 class="card-header mb-2 font-weight-bold text-dark" style="background: transparent!important;">' . INFO_JOB_STATUS . '</h4>
				<table   background="img/line1.gif" border="0"  width="95%" bgcolor="#ffffff"  cellspacing="0" cellpadding="3">
				<tr height="130">
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_job . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar1.gif"  height="' . $bar_jobs . '"   alt="' . $no_of_job . '" title="' . $no_of_job . '"   width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_active_job . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar2.gif" height="' . $bar_a_jobs . '"     alt="' . $no_of_active_job . '"   title="' . $no_of_active_job . '"     width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_applicant . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar3.gif" height="' . $bar_application . '" alt="' . $no_of_applicant . '" title="' . $no_of_applicant . '" width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_selectd_applicant . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar4.gif" height="' . $bar_selected . '"  alt="' . $no_of_selectd_applicant . '" title="' . $no_of_selectd_applicant . '"  width="45"></td></tr></table></td>
				</tr>
				<tr bgcolor="#ffffff" class="small">
				<td align="center"  class="small2"><b>' . INFO_JOBS . '</b></td>
				<td align="center"  class="small2">' . INFO_JOB_ACTIVE . '</td>
				<td align="center"  class="small2">' . INFO_TOTAL_APP . '</td>
   ...
   <div class="card card-jobseeker mb-3">
                <div class="card-body p-0">
				<h4 class="card-header mb-2 font-weight-bold text-dark" style="background: transparent!important;">Applicant Pipeline</h4>
		<table class="table-responsive" background="img/line1.gif" border="0"  width="95%" bgcolor="#ffffff"  cellspacing="0" cellpadding="3">
			<tr height="130">
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_applicant . '</td></tr><tr><td align="center" valign="bottom"> <img style="border:0px solid #00aadc" src="img/bar1.gif"  height="' . $bar_application . '"   alt="' . $no_of_applicant . '" title="' . $no_of_applicant . '"   width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_screen_round . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar2.gif" height="' . $bar_screen_round . '"     alt="' . $no_of_screen_round . '"   title="' . $no_of_screen_round . '"     width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_interview_round . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar3.gif" height="' . $bar_interview_round . '" alt="' . $no_of_interview_round . '" title="' . $no_of_interview_round . '" width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_telephone_round . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar4.gif" height="' . $bar_telephone_round . '"  alt="' . $no_of_telephone_round . '" title="' . $no_of_telephone_round . '"  width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_skill_round . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar5.gif"  height="' . $bar_skill_round . '"   alt="' . $no_of_skill_round . '" title="' . $no_of_skill_round . '"   width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_selectd_applicant . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar6.gif" height="' . $bar_selected . '"     alt="' . $no_of_applicant . '"   title="' . $no_of_applicant . '"     width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_joined . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar7.gif" height="' . $bar_joined . '" alt="' . $no_of_joined . '" title="' . $no_of_joined . '" width="45"></td></tr></table></td>
				<td align="center" valign="bottom"><table><tr><td align="center" class="small2">' . $no_of_declined . '</td></tr><tr><td align="center" valign="bottom"> <img style="border: 0px solid #00aadc" src="img/bar8.gif" height="' . $bar_declined . '"  alt="' . $no_of_declined . '" title="' . $no_of_declined . '"  width="45"></td></tr></table></td>
			</tr>
			<tr bgcolor="#ffffff" class="small">
				<td align="center"  class="small2"><b>' . INFO_TOTAL . '</b></td>
				...
				<td align="center"  class="small2">' . INFO_SELECTED . '</td>
				<td align="center"  class="small2">' . INFO_JOINED . '</td>
				<td align="center"  class="small2">' . INFO_DECLINED . '</td>
			</tr>
		</table>
		</div></div>';
	}
...
if (tep_not_null($row_contact['recruiter_logo']) && is_file(PATH_TO_MAIN_PHYSICAL_LOGO . $row_contact['recruiter_logo'])) {
	...
	$logo = '<td width="17%"><div class="dashboardlogo mini-profile-img-dashboard border m-text-center m-border-none">' . $logo . '</div></td>
    ';
} else {
	$logo = '<div>
				'.defaultProfilePhotoUrl(tep_db_output($row_contact['recruiter_company_name']),false,112,'class="" id=""').'
 			</div>
			<div style="position: absolute; top: 16px;  background: #7ce2f6; padding: 0px 4px;">
				<a href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION) . '" class="text-white">
...
$template->assign_vars(array(
	...
	'INFO_TEXT_POST_JOB'        => '<a href="' . tep_href_link(FILENAME_RECRUITER_POST_JOB) . '" title="' . INFO_TEXT_POST_JOB . '" class="customClass">' . INFO_TEXT_POST_JOB . '</a>',
	'INFO_TEXT_POST_JOB2'        => '<a href="' . tep_href_link(FILENAME_RECRUITER_POST_JOB) . '" title="' . INFO_TEXT_POST_JOB . '" class="style39 customClass2">' . INFO_TEXT_POST_JOB . '</a>',
...
' . INFO_TEXT_APPLY_WITHOUT_LOGIN . ' <label for="checkbox_rec_dr_log" class="switch">' . tep_draw_checkbox_field('direct_login', 'Yes', '', $direct_login, ' class="inputdemo" id="checkbox_rec_dr_log" onchange="this.form.submit();"') . '<span class="slider round"></span></label></form>',
    ...
    'INFO_LMS'=>((LMS_SETTING=='True')?'<div class="pb-1"><a href="'. tep_href_link(PATH_TO_LMS.LMS_COURSES_FILENAME) . '">LMS</a><div class="pb-1">':''),

    'INFO_TEST'=>((TEST_SETTING=='True')?'<div class="pb-1"><a href="' . tep_href_link(FILENAME_QUIZ.'/'.FILENAME_RECRUITER_ASSESSMENT) . '"class="style39">Online Test</a></div>':''),
	...
	'BOX_HEADING_TEST' => '<a href="' . tep_href_link(FILENAME_QUIZ.'/'.FILENAME_RECRUITER_ASSESSMENT) . '"class="style39">
								Online Test
							</a>',
