...
$template->assign_vars(array(
    'test_menus' => '
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ . FILENAME_JOBSEEKER_TESTS) . '">
                        ' . MY_TESTS . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_JOBSEEKER_TESTS,'action=latest-report') . '">
                        ' . LATEST_REPORT . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_QUIZ_CALENDAR) . '">
                        ' . CALENDAR . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_JOBSEEKER_TESTS,'action=video-library') . '">
                        ' . MY_VIDEO . '
                    </a>
