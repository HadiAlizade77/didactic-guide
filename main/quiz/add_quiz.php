...
function find_test_with_an_id_and_get($test_id = null, int $recruiter_id)
{
    global $template;
...
function type_is_mcq($action, $quiz_id, $recruiter_id) {
    ...
    $template->assign_vars(array(
        ...
        'ADD_NEW_ANS_BTN'   => '<span class="btn btn-sm btn-outline-success me-3" id="add-answer"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-plus-lg" viewBox="0 0 16 16">
        <path fill-rule="evenodd" d="M8 2a.5.5 0 0 1 .5.5v5h5a.5.5 0 0 1 0 1h-5v5a.5.5 0 0 1-1 0v-5h-5a.5.5 0 0 1 0-1h5v-5A.5.5 0 0 1 8 2Z"/>
      </svg></span>',
        'CHOICE_LABEL'      => 'Choice',
        'POINT_LABEL'       => 'Point',
