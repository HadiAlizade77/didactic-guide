...
$template->assign_vars(array(
    'test_menus' => '
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ . FILENAME_JOBSEEKER_TESTS) . '" class="hm_color">
                        ' . MY_TESTS . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_JOBSEEKER_TESTS,'action=latest-report') . '" class="hm_color">
                        ' . LATEST_REPORT . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_QUIZ_CALENDAR) . '" class="hm_color">
                        ' . CALENDAR . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_JOBSEEKER_TESTS,'action=video-library') . '" class="hm_color">
                        ' . MY_VIDEO . '
                    </a>
                    <a class="btn btn-sm btn-outline-primary me-2" href="' . tep_href_link(PATH_TO_QUIZ.FILENAME_JOBSEEKER_TESTS,'action=invitation-link') . '">
                        ' . MY_INVITATION . '
                    </a>
    ',
