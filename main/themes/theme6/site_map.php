...
$jobseeker_site_map='
<p class="card-text"><a href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">'.INFO_TEXT_LOGIN.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_JOBSEEKER_CONTROL_PANEL).'">'.INFO_POST_RESUME.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_JOB_SEARCH).'">'.INFO_TEXT_SEARCH_JOBS.'</a></p>


<p class="card-text"><a href="'.tep_href_link(FILENAME_JOB_SEARCH_BY_INDUSTRY).'">'.INFO_TEXT_BY_CATEGORY.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_JOB_SEARCH_BY_LOCATION).'">'.INFO_TEXT_BY_LOCATION.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_JOBSEEKER_COMPANY_PROFILE).'">'.INFO_TEXT_BY_COMPANY.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_JOB_SEARCH).'">'.INFO_TEXT_ADVANCE_SEARCH.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_ARTICLE).'">'.INFO_TEXT_CAREER_ADVICE.'</a></p>';

$recruiter_site_map='

<p class="card-text"><a href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'">'.INFO_TEXT_LOGIN.'</a></p>
...
<p class="card-text"><a href="'.tep_href_link(FILENAME_ABOUT_US).'">'.INFO_TEXT_ABOUT_US.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_FAQ).'">'.INFO_TEXT_FAQS.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_FAQ).'">'.INFO_TEXT_JOB_SEEKER_FAQS.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_FAQ).'">'.INFO_TEXT_EMPLOYER_FAQS.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_INDUSTRY_RSS).'">'.INFO_TEXT_RSS_BY_CATEGORY.'</a></p>
...
<p class="card-text"><a href="'.tep_href_link(FILENAME_ARTICLE).'">'.INFO_TEXT_NEWS.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_ADVERTISE).'">'.INFO_TEXT_ADVERTISE_WITH_US.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_TERMS).'">'.INFO_TEXT_TERMS.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_PRIVACY).'">'.INFO_TEXT_PRIVACY.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_CONTACT_US).'">'.INFO_TEXT_Contact_Us.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_SERVICES).'">'.INFO_TEXT_SERVICES.'</a></p>';
