...
We use cookies to provide and improve our services. By using our site, you consent to cookies. <a class="btn btn-sm acceptcookies-btn" href="'.tep_href_link(FILENAME_PRIVACY).'" target="_blank"> Learn more</a>
<button type="button" class="btn btn-sm acceptcookies" aria-label="Close">Ok, I Accept</button>
</div>
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    <html lang="en">
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme6/css/theme6.css").'">
...
<style type="text/css">
	.fixed-top {
        ...
        '.$cookie_alert_popup.'
            ...
            <nav id="navbar_top" class="navbar navbar-expand-lg navbar-light bg-light fixed-top">
			<div class="container max-width">
               <a class="navbar-brand" href="'.tep_href_link("").'"><img src="'.tep_href_link('img/'.DEFAULT_SITE_LOGO).'" alt="Jobboard Logo"></a>
                ...
                '.(check_login("jobseeker")?'':'
                    ...
                    <li class="nav-item active">
                        '.(check_login("jobseeker")?'
                            <a class="nav-link active-btn" href="'.tep_href_link(FILENAME_JOBSEEKER_RESUME1).'">
                                '.INFO_POST_RESUME.'
                            </a>':'
                            <a class="nav-link active-btn" href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'">
                            '.INFO_POST_JOB.'
                            </a>').'
                    </li>
