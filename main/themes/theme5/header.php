...
<!DOCTYPE html>
    <html lang="en">
		...
		<link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme5/css/theme5.css").'">
...
<style type="text/css">
    ...
    <nav class="navbar navbar-expand-lg 1navbar-light bg-light border-bottom fixed-top">
    <div class="container">
...
<li class="nav-item active">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'" type="button">'.INFO_TEXT_MENU_POST_JOB.'</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    '.(check_login("jobseeker")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_RESUME1).'">Post Resume</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">Post Resume</a>').'
                    <a class="dropdown-item" href="'.tep_href_link(FILENAME_JOB_SEARCH).'">Search Jobs</a>
                    '.(check_login("jobseeker")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_LOGOUT).'">Logout</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">Login</a>').'
                    '.(check_login("jobseeker")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_CONTROL_PANEL).'">Control Panel</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'">Register</a>').'
                    '.(check_login("jobseeker")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_LIST_OF_APPLICATIONS).'">View Applications</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">View Applications</a>').'
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                    '.(check_login("recruiter")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'">Post Jobs</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'">Post Jobs</a>').'
                    <a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_SEARCH_RESUME).'">Search Resume</a>
                    '.(check_login("recruiter")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_LOGOUT).'">Logout</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'">Login</a>').'
                    '.(check_login("recruiter")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_CONTROL_PANEL).'">Control Panel</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'">Register</a>').'
                    '.(check_login("recruiter")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_SEARCH_APPLICANT).'">Applicant Tracking</a>':
                    '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'">Applicant Tracking</a>').'
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                        <a class="dropdown-item" href="'.tep_href_link("forum/").'">Forum </a>
                        <a class="dropdown-item" href="'.tep_href_link(FILENAME_ARTICLE).'">Articles</a>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    ...
                    <a class="nav-link btn btn-sm btn-theme-six px-3" href="'.tep_href_link(FILENAME_LOGIN).'">'.INFO_TEXT_MENU_SIGNIN.'</a>').'
                </li>
