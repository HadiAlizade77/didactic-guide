...
{	$jobrec_profilemenu='
    ...
    <a class="nav-link theme4-nav-link dropdown-toggle" href="#" id="dropdown01" data-bs-toggle="dropdown" aria-haspopup="true" aria-expanded="false">'.$photo.'</a>
...
if(COOKIE_ALERT_POPUP=='true')
	$cookie_alert_popup='
    <!-- /.container -->
<div class="alert-warning alert-dismissible fade text-center cookiealert" role="alert"><strong>Cookies: </strong> This website uses cookies to improve your experience. We will assume you\'re ok with this, but you can opt-out if you wish. <a class="btn btn-sm acceptcookies-btn" href="'.tep_href_link(FILENAME_PRIVACY).'" target="_blank"> Learn more</a><button type="button" class="btn btn-secondary btn-sm acceptcookies" aria-label="Close">OK, I ACCEPT</button></div>
';
else
$cookie_alert_popup='';
///////////////////////////////////////////////////////////////////////////////////////////////////
...
<!DOCTYPE html>
    ...
    <link href="'.tep_href_link("css/half-slider.css").'" rel="stylesheet">-->

    <link rel="stylesheet" type="text/css" href="'.tep_href_link("css/custom.css").'"> 
	<link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme4/css/theme4.css").'">
    ...
    <!--<script language="javascript">
            ...
            $("#job-category a[role=tab]").click(function (e) {
            e.preventDefault()
            var attr = $(this).attr("href")
            console.log(attr)
            console.log($(attr).is(":visible"))
            if($(attr).is(":visible")) {
            $(this).tab("hide")
            } else {
            $(this).tab("show")
...
<nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom fixed-top">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto align-items-center align-items-center">

                <!--<li class="nav-item">
                    <a class="nav-link theme4-nav-link" href="#" type="button" class="dropbtn" onclick="event.preventDefault();location.href=\''.tep_href_link("").'\'">'.INFO_TEXT_MENU_HOME.'</a>
                    </li>-->
                    <li class="nav-item dropdown">
                        <a
                ...
                <li class="nav-item">
                    <a class="nav-link theme4-nav-link" href="#" type="button" class="dropbtn" onclick="event.preventDefault();location.href=\''.tep_href_link(FILENAME_JOBSEEKER_RESUME1).'\'">Register CV</a>

                </li>

                <li class="nav-item">
                    <a class="nav-link theme4-nav-link" href="#" type="button" class="dropbtn" onclick="event.preventDefault();location.href=\''.tep_href_link(FILENAME_JOB_SEARCH).'\'">Search Jobs</a>
                    
                </li>

                <li class="nav-item">
                    <a class="nav-link theme4-nav-link" href="#" type="button" class="dropbtn" onclick="event.preventDefault();location.href=\''.tep_href_link(FILENAME_JOB_ALERT_AGENT).'\'">Jobs by Email</a>
                    
                </li>

                <li class="nav-item">
                    <a class="nav-link theme4-nav-link" href="#" type="button" class="dropbtn" onclick="event.preventDefault();location.href=\''.tep_href_link(FILENAME_JOBSEEKER_COMPANY_PROFILE).'\'">Company A-Z</a>
                    
                </li>

                '.(check_login("recruiter")?'
                <li class="nav-item">
                    <a class="nav-link theme4-nav-link btn btn-sm theme4-btn mt-1 ml-2 px-3" href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'" role="button">
                        Recruiting?
                    </a>
                </li>':'
                <li class="nav-item">
                    <a class="nav-link theme4-nav-link btn btn-sm theme4-btn mt-1 ml-2 px-3" href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'" role="button">
                        Recruiting?</a>
                </li>').'
