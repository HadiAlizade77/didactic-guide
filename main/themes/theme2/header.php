...
if(check_login("jobseeker"))
{
    ...
    $membership=(!tep_not_null($row['id'])?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_RATES).'">'.INFO_TEXT_HEADER_MIDDLE_PREMIUM_MEMBERSHIP.'</a>':'<li class="divider"></li><li><a href="'.tep_href_link(FILENAME_JOBSEEKER_ACCOUNT_HISTORY_INFO).'">'.INFO_TEXT_HEADER_MIDDLE_PREMIUM_MEMBERSHIP.'<i class="fa fa-shopping-cart pull-right" aria-hidden="true"></i></a></li>');
}
...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <link href="'.tep_href_link("themes/theme2/css/theme2.css").'" rel="stylesheet" type="text/css">
...
<li class="nav-item active">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        '.(check_login("recruiter") || check_login("jobseeker")?'':'
                        <li class="nav-item">
                            <a class="nav-link" href="'.tep_href_link(FILENAME_LOGIN).'">Login</a>
                        </li>')

                        .(check_login("recruiter") || check_login("jobseeker")?'':'
                        <li class="nav-item">
                            <a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'">Register</a>
                        </li>')
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <div class="dropdown-menu" aria-labelledby="navbarDropdownMenuLink">
                                <a class="dropdown-item" href="'.tep_href_link("forum/").'">Forum </a> <a class="dropdown-item" href="'.tep_href_link(FILENAME_ARTICLE).'">Articles</a>
                            </div>
                        </li>
