...
define('HEADER_HTML','<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
...
<link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme9/css/theme9.css").'">
...
'.$cookie_alert_popup.'
<nav id="navbar_top" class="navbar navbar-expand-lg navbar-light bg-light fixed-top border-bottom">
            <div class="container">
      ...
      <li class="nav-item dropdown">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_LIST_OF_APPLICATIONS).'">View Applications</a>
