...
<html lang="en">
    ...
    <head>
        ...
        <link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme8/css/theme8.css").'">
...
<nav id="navbar_top" class="navbar navbar-expand-lg navbar-light bg-light fixed-top border-bottom theme8-bg-light px-3">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarNavDropdown">
            <ul class="navbar-nav ms-auto align-items-center">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link("").'" type="button" class="dropbtn">Home</a>
                </li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        '.(check_login("jobseeker")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_CONTROL_PANEL).'">Dashboard</a>':
                        '<a class="dropdown-item" href="'.tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'">Register</a>').'
                        <a class="dropdown-item" href="'.tep_href_link("").'">View Applications</a>
            ...
            '.(check_login("jobseeker")?'':'
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_POST_JOB).'">Post jobs</a>
                        <a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_SEARCH_RESUME).'">Search resume</a>
                        '.(check_login("recruiter")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_LOGOUT).'">Sign out</a>':
                        '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_LOGIN).'">Login</a>').'
                        '.(check_login("recruiter")?'<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_CONTROL_PANEL).'">Dashboard</a>':
                        '<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'">Register</a>').'
                        <a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_SEARCH_APPLICANT).'">Applicant tracking</a>
						<a class="dropdown-item" href="'.tep_href_link(FILENAME_RECRUITER_RATES).'"  type="button" class="dropbtn">Pricing</a>
                    </div>
                </li>').'

                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_RECRUITER_RATES).'" type="button" class="dropbtn">Pricing</a>
                </li>

                <li class="nav-item">
                    <a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_COMPANY_PROFILE).'" type="button" class="dropbtn">Companies</a>
                </li>
                <li class="nav-item">
                    '.(check_login("jobseeker") || check_login("recruiter")?'':'<a class="nav-link" href="'.tep_href_link(FILENAME_RECRUITER_REGISTRATION).'">Sign up</a>').'
                </li>
