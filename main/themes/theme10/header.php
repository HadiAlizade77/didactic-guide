...
{	$jobrec_profilemenu='
    ...
    <a class="dropdown-item" href="'.tep_href_link(FILENAME_LOGOUT).'">'.INFO_TEXT_HM_LOGOUT.'</a><li class="nav-item toggleButton">
  </li>
...
# custome class for internal page not for home
// $custom_internal_class_name = '';
// $dark_light_css = '';
// if(strtolower($_SERVER['PHP_SELF'])=="/".PATH_TO_MAIN.FILENAME_INDEX) {
//     $custom_internal_class_name .= '';
//     $dark_light_css .= '';
// } else {
//     $custom_internal_class_name .= 'theme10_internalClass';
...
<link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/theme10/css/theme10-internal.css").'">-->
...
'.$cookie_alert_popup.'
<nav id="navbar_top" class="navbar navbar-expand-lg navbar-light bg-darks fixed-top'.$custom_internal_class_name.'">
            <div class="container">
                <a class="navbar-brand theme10-navbar-brand" href="'.tep_href_link("").'">
