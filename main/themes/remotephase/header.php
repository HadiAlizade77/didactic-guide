...
We use cookies to provide and improve our services. By using our site, you consent to cookies. <a class="btn btn-sm acceptcookies-btn" href="'.tep_href_link(FILENAME_PRIVACY).'" title="click" rel="noopener nofollow sponsored ugc" target="_blank">Privacy</a>
<button type="button" class="btn btn-sm acceptcookies" aria-label="Close">Okay</button>
</div>
...
///////////////////////////////////////////////////////////////////////////////////////////////////
    ...
    <html lang="en">
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="'.tep_href_link("css/remote.css").'">

            <!--<link rel="stylesheet" type="text/css" href="'.tep_href_link("fonts/font-awesome.min.css").'">
            <link rel="preconnect" href="https://fonts.gstatic.com">
			<link href="https://fonts.googleapis.com/css2?family=Lato:wght@300;400;700&display=swap" rel="stylesheet">-->

            <link rel="stylesheet" type="text/css" href="'.tep_href_link("themes/remotephase/css/theme1.css").'">
        ...
        '.$cookie_alert_popup.'
            ...
            <nav class="navbar navbar-expand-lg 1navbar-light bg-light fixed-top">
			<div class="container">
                <a class="navbar-brand" href="'.tep_href_link("").'"><img src="'.tep_href_link('img/'.DEFAULT_SITE_LOGO).'" alt="Jobboard Logo"></a> <span class="punchline">Find Remote Jobs</span>
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    ...
                    '.(check_login("jobseeker") || check_login("recruiter")?'':'<li class="nav-item upload-resume me-3">
                        <a class="nav-link" href="'.tep_href_link(FILENAME_JOBSEEKER_RESUME5).'">Upload Resume</a>
                    </li>').'

                    <li class="nav-item me-1">
                        '.(check_login("jobseeker")?'
                        <a class="nav-link text-primary" style="font-weight: 600;" href="'.tep_href_link(FILENAME_LOGOUT).'">
                        '.INFO_TEXT_MENU_LOGOUT.'</a>':(check_login("recruiter")?'<a class="nav-link text-primary" style="font-weight: 600;" href="'.tep_href_link(FILENAME_LOGOUT).'">'.INFO_TEXT_MENU_LOGOUT.'</a>':
                        '<a class="nav-link text-primary" style="font-weight: 600;" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">'.INFO_TEXT_MENU_LOGIN.'</a>')).'
                    </li>
