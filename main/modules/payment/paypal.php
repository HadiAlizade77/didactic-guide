...
// class methods
    ...
    function process_button() {
      ...
      $process_button_string = tep_draw_hidden_field('cmd', '_xclick') .
                               ...
                               tep_draw_hidden_field('amount', $currencies->format_without_symbol($order->info['total'], ($my_currency!=DEFAULT_CURRENCY?true:false), DEFAULT_CURRENCY, ($my_currency==DEFAULT_CURRENCY?$currencies->get_value($my_currency):''))) .
