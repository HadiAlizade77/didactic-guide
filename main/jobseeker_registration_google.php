...
include_once(PATH_TO_MAIN_PHYSICAL_LANGUAGE.$language.'/'.FILENAME_JOBSEEKER_REG_GOOGLE);
$template->set_filenames(array('registration' => 'jobseeker_registration_google.htm','email'=>'jobseeker_registration_template.htm','fr_email'=>'fr_jobseeker_registration_template.htm'));
...
if(isset($_SESSION['access_token']))
{
 ...
 {
  $_SESSION['REDIRECT_URL']=FILENAME_JOBSEEKER_REGISTER1;
  $_SESSION['google_error']='through Google jobseeker registration disable by admin.use normal way to register';
  unset($_SESSION['access_token']);
  tep_redirect(FILENAME_GOOGLE_APPLICATION1);
 }
...
$template->assign_vars(array(
 ...
 'registration_form'       => tep_draw_form('registration', FILENAME_JOBSEEKER_REG_GOOGLE, '', 'post', 'onsubmit="return ValidateForm(this)"').tep_draw_hidden_field('action','new'),
