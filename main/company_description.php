...
$button1='';
$form1='';
$button=tep_draw_submit_button_field('','Preview','class="btn btn-primary" onclick=set_action("preview")');//tep_image_submit(PATH_TO_BUTTON.'button_preview.gif',IMAGE_PREVIEW,"onclick=set_action('preview')");
...
if($row=getAnyTableWhereData(COMPANY_DESCRIPTION_TABLE,"recruiter_id='".$_SESSION['sess_recruiterid']."'"))
{
 ...
 $button.=' '.tep_draw_submit_button_field('','Update','class="btn btn-outline-secondary m-btn-block m-m-t-10" onclick=set_action("update")');//tep_image_submit(PATH_TO_BUTTON.'button_update.gif',IMAGE_UPDATE,"onclick=set_action('update')");
}
else
{
 $c_description='';
 $button.=' '.tep_draw_submit_button_field('','Insert','class="btn btn-outline-secondary m-btn-block m-m-t-10" onclick=set_action("update")');//tep_image_submit(PATH_TO_BUTTON.'button_insert.gif',IMAGE_INSERT,"onclick=set_action('update')");
