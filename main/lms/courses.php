...
$template->assign_vars(array(
    ...
    'new_button' => '
        <a
            ...
            <i class="fa fa-plus" aria-hidden="true"></i> <i class="bi bi-plus-lg"></i> New Course
        </a>
    ',
...
if ($action == 'new' || $action == 'edit') {
    ...
    $template->assign_vars(array(
        'HEADING_TITLE'         => '<h1>'.HEADING_TITLE . '</h1> <span class="badge small bg-secondary ms-2">'.paginate_lms_course()['totalData'].'</span>',
