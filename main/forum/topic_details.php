  ...
  case 'save':
     ...
     if(!$error)
     {
      ...
      $sql_data_array=array('description'  => $description,
       ...
       tep_redirect(tep_href_link(PATH_TO_FORUM.encode_forum($topic_info['title']).'_'.$topic_id.'.html'));
     }
...
if($action=='preview') 
{
 ...
 'INFO_TEXT_FORUM_HEADER_LINK'  => '<a href="'.tep_href_link(PATH_TO_FORUM).'" class="forum_sub_heading">'.INFO_TEXT_HOME.'</a>&nbsp;&gt;&gt;&nbsp;<a href="'.tep_href_link(PATH_TO_FORUM.$topic_info['id'].'/'.encode_forum($topic_info['forum_title']).'.html').'" class="forum_sub_heading">'.$topic_info['forum_title'].'</a>&nbsp;&gt;&gt;&nbsp;<a href="'.tep_href_link(PATH_TO_FORUM.encode_forum(((strlen($topic_info['title'])<150)?$topic_info['title']:substr($topic_info['title'],0,148)."..")).'_'.$_POST['topic_id'].'.html').'" class="forum_sub_heading">'.$topic_info['title'].'</a>',
  ...
  if($title=='')
  {
   ...
   $title=$title;
		$template->assign_vars(array( 
			...
			'form'=>$form,
			'forum_title'   => $topic_info['title'],
			'INFO_TEXT_FORUM_HEADER_LINK'          => '<a href="'.tep_href_link(PATH_TO_FORUM).'" class="forum_sub_heading">'.INFO_TEXT_HOME.'</a>&nbsp;&gt;&gt;&nbsp;<a href="'.tep_href_link(PATH_TO_FORUM.$topic_info['id'].'/'.encode_forum($topic_info['forum_title']).'.html').'" class="forum_sub_heading">'.$topic_info['forum_title'].'</a>&nbsp;&gt;&gt;&nbsp;<a href="'.tep_href_link(PATH_TO_FORUM.encode_forum(((strlen($topic_info['title'])<150)?$topic_info['title']:substr($topic_info['title'],0,148)."..")).'_'.$topic_id.'.html').'" class="forum_sub_heading">'.$topic_info['title'].'</a>',
...
//  'new_button'    => '<a href="'.FILENAME_TOPIC_DETAILS.'?action=new&topic_id='.$_GET['topic_id'].'">'.tep_image_button(PATH_TO_BUTTON.'reply_to_thread.gif',IMAGE_NEW).'</a>&nbsp;&nbsp;',
 'new_button' => tep_link_button_Name( FILENAME_TOPIC_DETAILS.'?action=new&topic_id='.$_GET['topic_id'],
                ...
                'Reply To Thread',
                'Link'),
 'INFO_TEXT_FORUM_HEADER_LINK'          => '<a href="'.tep_href_link(PATH_TO_FORUM).'" class="forum_sub_heading1">'.INFO_TEXT_HOME.'</a>&nbsp;&gt;&gt;&nbsp;<a href="'.tep_href_link(PATH_TO_FORUM.$topic_info['id'].'/'.encode_forum($topic_info['forum_title']).'.html').'" class="forum_sub_heading1">'.$topic_info['forum_title'].'</a>&nbsp;&gt;&gt;&nbsp;<a href="'.tep_href_link(PATH_TO_FORUM.encode_forum(((strlen($topic_info['title'])<150)?$topic_info['title']:substr($topic_info['title'],0,148)."..")).'_'.$_GET['topic_id'].'.html').'" class="forum_sub_heading1">'.$topic_info['title'].'</a>',
