 ...
 while($row11 = tep_db_fetch_array($result))
 {
  ...
  if($total_forum)
  {
   ...
   while($forum_row = tep_db_fetch_array($forum_result))
   {
    ...
    $forum_link=$forum_row['id'].'/'.encode_forum($forum_row['title']).'.html';
...
$template->assign_vars(array(
 ...
 'INFO_TEXT_HEADING_SEARCH' => '<a class="btn btn-sm btn-primary" href="'.tep_href_link(PATH_TO_FORUM.FILENAME_FORUM_SEARCH).'" class="forum_heading_link"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-search" viewBox="0 0 16 16">
