...
class twitter
{
 ...
 function twitter_check_authentication($oauth_consumer_key='',$app_consumer_secret='',$oauth_token='',$oauth_token_secret='')
 {
  ...
  $authentication_url = 'https://api.twitter.com/1.1/account/verify_credentials.json';
  ...
  if($info['http_code']==200)
  {
   ...
   if(isset($res->screen_name))
    $this->message=$res->screen_name;
   return true;
  }
  else
  {
