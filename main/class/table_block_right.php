...
class tableBlockRight
{
	...
	{}
// 	function tableBlockRight($contents) 
// 	{
// 		$tableBox_string = '';
//   $tableBox_string.='          
//          <table border="0" width="100%" cellspacing="1" cellpadding="0" class="right_table1">
//           <tr>
//            <td valign="top">
//             <table border="0" width="100%" cellspacing="0" cellpadding="0" class="right_table2">
//              <tr>
//               <td valign="top">';
// 		$form_after_tr='';
// 		$form_set = false;
