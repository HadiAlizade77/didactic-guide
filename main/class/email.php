 ...
 */
    ...
    function add_attachment($content, $file_name = '', $c_type='application/octet-stream', $encoding = 'base64') {
      $this->attachments[] = array('body' => $content,
                                   'name' => $file_name,
                                   'c_type' => $c_type,
                                   'encoding' => $encoding);
    }
...
//    function build_message($params = array()) {
    function build_message($params = '') {
      ...
      $text = ((tep_not_null($this->text)) ? true : false);
						//echo $attachments." : ".$html_images." : ".$html." : ".$text;die();
      switch (true) {
