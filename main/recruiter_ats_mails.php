...
elseif($mail_id>0)
{
 ...
 tep_db_query("update ".APPLICANT_INTERACTION_TABLE." set user_see='Yes' where id='".$mail_id."'");
  ...
  'INFO_TEXT_BACK'=>'<a href="'.FILENAME_RECRUITER_ATS_MAILS.'"><button class="btn btn-primary" >Back</button>',
...
else
{
 ...
 if($show_mail_status=='Inbox')
  $view_link1 =INFO_TEXT_VIEW_IN."<a href='#'  onclick='view_data(\"all\",\"send\")'>".INFO_TEXT_VIEW_SEND."</a> | <a href='#' class='red'  onclick='view_data(\"all\",\"inactive\")'>".INFO_TEXT_VIEW_TRASH."</a>  | <a href='".tep_href_link(FILENAME_RECRUITER_APPLICANT_TRACKING)."'>Compose</a>";
 elseif($show_mail_status=='Send')
  $view_link1 =INFO_TEXT_VIEW_IN."<a href='#'  onclick='view_data(\"all\",\"active\")'>".INFO_TEXT_VIEW_INBOX."</a> | <a href='#' class='red'  onclick='view_data(\"all\",\"inactive\")'>".INFO_TEXT_VIEW_TRASH."</a>  | <a href='".tep_href_link(FILENAME_RECRUITER_APPLICANT_TRACKING)."'>Compose</a>";
 else
  $view_link1 =INFO_TEXT_VIEW_IN. "<a href='#'  onclick='view_data(\"all\",\"send\")'>".INFO_TEXT_VIEW_SEND."</a> | <a href='#'   onclick='view_data(\"all\",\"active\")'>".INFO_TEXT_VIEW_INBOX."</a>  | <a href='".tep_href_link(FILENAME_RECRUITER_APPLICANT_TRACKING)."'>Compose</a>";
