...
else
{
  ...
  ////////////////
  $different_jobs='<a class="btn btn-outline-primary me-3 m-border" href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort'))).'&j_status=active" class="hm_color">'.INFO_TEXT_ACTIVE_JOBS.'</a>';

  $different_jobs.='<a class="btn btn-outline-primary me-3 m-border" href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort'))).'&j_status=expired" class="hm_color">'.INFO_TEXT_EXPIRED_JOBS.'</a>';

  $different_jobs.='<a class="btn btn-outline-primary me-3 m-border" href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort'))).'&j_status=deleted" class="hm_color">'.INFO_TEXT_DELETED_JOBS.'</a>';

  $different_jobs.='<a class="btn btn-outline-primary me-3 for-mobile m-border" href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, 'page=1&'.tep_get_all_get_params(array('action','page','jobID','j_status','sort'))).'&j_status=other" class="hm_color">'.INFO_TEXT_OTHER_JOBS.'</a>';
  /////////////
...
switch ($action)
{
  case 'delete_screener':
	...
	<div class="">
	  ...
	  <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('page','action'))).'&action=confirm_screener_delete' . '"><button class="btn btn-primary mr-2">Confirm</button></a> <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('action'))) . '"><button class="btn btn-outline-secondary">Cancel</button></a>
...
';
  ...
  case 'del_job':
    ...
    <h4 class="m-0">'.ucfirst(tep_db_output($jInfo->job_title)).'</h4>
	  ...
	  <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('page','action'))).'&action=confirm_delete' . '"><button class="btn btn-primary mr-2">Confirm</button></a> <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('action'))) . '"><button class="btn btn-outline-secondary">Cancel</button></a>
...
<div class="">
  <a href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('jobID'))).'&jobID='.$jInfo->job_id.'&action=edit_screener'.'" class=" ">'.IMAGE_EDIT_SCREENER.' <span class="float-right"><i class="fa fa-edit text-muted" aria-hidden="true"></i></span></a>
</div>

<div class="">
  <a href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('jobID'))).'&jobID='.$jInfo->job_id.'&action=delete_screener'.'" class=" ">'. IMAGE_DELETE_SCREENER.' <span class="float-right"><i class="fa fa-trash text-muted" aria-hidden="true"></i></span></a>
</div>
';
}
else
{
  ...
  <a href="'.tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('jobID'))).'&jobID='.$jInfo->job_id.'&action=add_screener'.'" class="list-group-item list-group-item-action"><i class="bi bi-person-badge-fill me-2"></i> <span class="m-none">'.IMAGE_ADD_SCREENER.'</span></a>';
}
if ((tep_not_null($jInfo->job_id)) && !(tep_not_null($action)))
{
  ...
  <h4 class="m-0 text-dark">'.ucfirst(tep_db_output($jInfo->job_title)).'</h4>
  ...
  <div class="list-group" style="border-top-left-radius:0;border-top-right-radius:0;">
	  <a href="' . tep_href_link(FILENAME_RECRUITER_VIEW_JOB,'jobID='.$jInfo->job_id).'" class="list-group-item list-group-item-action"><i class="bi bi-eye-fill me-2"></i> <span class="m-none">'.IMAGE_VIEW_JOB.'</span></a>
	  '.$re_adv.
	  (tep_not_null($jInfo->deleted)?'<a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('jobID','action'))).'&jobID='.$jInfo->job_id.'&action=undelete_job' . '" class="list-group-item list-group-item-action"><i class="bi bi-pencil-square"></i> <span class="m-none">'.IMAGE_UNDELETE_JOB.' </a>':'<a href="' . tep_href_link(FILENAME_RECRUITER_POST_JOB,'jobID='.$jInfo->job_id).'" class="list-group-item list-group-item-action"><i class="bi bi-pencil-square me-2"></i> <span class="m-none">'.IMAGE_EDIT_JOB.'</span></a>').'
	  <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_JOBS, tep_get_all_get_params(array('jobID','action'))).'&jobID='.$jInfo->job_id.'&action=del_job' . '" class="list-group-item list-group-item-action"><i class="bi bi-trash3-fill me-2"></i> <span class="m-none">'.IMAGE_DELETE_JOB.'</span></a>
	  <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_APPLICATIONS, 'jobID='.$jInfo->job_id).'" class="list-group-item list-group-item-action" tabindex="-1" aria-disabled="true"><i class="bi bi-file-earmark-text-fill me-2"></i> <span class="m-none">'.IMAGE_APPLICATIONS.'</span></a>
	  <a href="' . tep_href_link(FILENAME_RECRUITER_LIST_OF_SELECTD_APPLICANT, 'jobID='.$jInfo->job_id).'" class="list-group-item list-group-item-action" tabindex="-1" aria-disabled="true"><i class="bi bi-person-check-fill me-2"></i> <span class="m-none">'.IMAGE_SELECTED_APPLICATIONS.'</span></a>

	  '.$add_edit_screener.'

	  <a href="' . tep_href_link(FILENAME_RECRUITER_RESUME_WEIGHT, 'jobID='.$jInfo->job_id).'" class="list-group-item list-group-item-action" tabindex="-1" aria-disabled="true"><i class="bi bi-percent me-2"></i> <span class="m-none">'.INFO_TEXT_RESUME_WEIGHT.'</span></a>
	  <a href="' . tep_href_link(FILENAME_RECRUITER_APPLICATION_REPORT, 'jobID='.$jInfo->job_id).'" class="list-group-item list-group-item-action" tabindex="-1" aria-disabled="true"><i class="bi bi-bar-chart-fill me-2"></i> <span class="m-none">'.IMAGE_REPORT.'</span></a>
	</div>
