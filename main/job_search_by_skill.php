...
//////**********currency display ***************************/
 ...
 $template->assign_vars(array( 'hidden_fields' => $hidden_fields,
  ...
  'INFO_TEXT_APPLY_BUTTON' => (($x>0)?(check_login("jobseeker")?'<a class="btn btn-success m-btn-success" onclick="ckeck_application(\'\');" role="button">Apply to Selected Jobs</a>':'<a class="btn btn-primary" onclick="ckeck_application(\'\');" role="button">Registered User</a> <a class="btn btn-success m-btn-success" onclick="ckeck_application(\'new\');" role="button">New User</a>'):''),
