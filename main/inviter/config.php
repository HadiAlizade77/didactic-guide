<?php
	$openinviter_settings=array(
		"username"=>"shambhu",
		"private_key"=>"77420902cd929b5947af831c58987125",
		"cookie_path"=>'D:\Apache2\htdocs\jobsite_multilingual2\inviter\temp',
	    //"cookie_path"=>'/server_path/inviter/temp',
		"message_body"=>"You are invited to aynsoft.com", // aynsoft.com is the website on your account. If wrong, please update your account at OpenInviter.com
		"message_subject"=>" is inviting you to aynsoft.com", // aynsoft.com is the website on your account. If wrong, please update your account at OpenInviter.com
