...
///*
$table_name=JOBSEEKER_ORDER_TABLE." as o, ".JOBSEEKER_ORDER_HISTORY_TABLE." as oh";
$whereClause="oh.order_id=o.orders_id and o.jobseeker_id='".$_SESSION['sess_jobseekerid']."'";
