...
<p class="card-text"><a href="'.tep_href_link(FILENAME_ARTICLE).'">'.INFO_TEXT_BLOG.'</a></p>

<p class="card-text"><a href="'.tep_href_link('forum/').'">'.INFO_TEXT_FORUM.'</a></p>

<p class="card-text"><a href="'.tep_href_link(PATH_TO_LMS.LMS_LIST_COURSES_FILENAME).'">'.INFO_TEXT_COURSES.'</a></p>

<p class="card-text"><a href="'.tep_href_link(FILENAME_JOBFAIR).'">'.INFO_TEXT_JOBFAIR.'</a></p>
