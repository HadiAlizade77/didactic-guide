...
$NEW_USER_REGISTER_NOW1='<a href="' . tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'"  class="btn btn-100 btn-outline-secondary my-2">'.INFO_TEXT_REGISTER_NOW1.'</a>';
$NEW_USER_REGISTER_NOW2='<a href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION).'" class="btn btn-100 btn-outline-secondary my-2">'.INFO_TEXT_REGISTER_NOW2.'</a>';
$FORGOT_PASSWORD1='<a class="small" href="'.tep_href_link(FILENAME_JOBSEEKER_FORGOT_PASSWORD).'">'.INFO_TEXT_FORGOT_PASSWORD1.'</a>';
$FORGOT_PASSWORD2='<a class="small" href="' . tep_href_link(FILENAME_RECRUITER_FORGOT_PASSWORD).'">'.INFO_TEXT_FORGOT_PASSWORD2.'</a>';
...
$AUTO_LOGIN2=tep_draw_checkbox_field('auto_login2','on', $checked2,'','id="auto_login2" class="form-check-input"').'<label class="form-check-label" for="auto_login2" >'.AUTO_LOGIN2.'<label>';
...
if(!check_login("jobseeker"))
{
 ...
 $social_login_button.=' <a href="'.FILENAME_FACEBOOK_APPLICATION.'" title="Sign in with Facebook"><img class="rounded-12" src="img/facebook.png" alt="Facebook"></a>';

 if(MODULE_GOOGLE_PLUGIN=='enable' && MODULE_GOOGLE_PLUGIN_JOBSEEKER=='enable')
 $social_login_button.=' <a class="mx-auto" href="'.FILENAME_GOOGLE_APPLICATION.'" title="Sign in with Google"><img class="rounded-12" src="img/google.png" alt="Google"></a>';

 if(MODULE_LINKEDIN_PLUGIN=='enable' && MODULE_LINKEDIN_PLUGIN_JOBSEEKER=='enable')
 $social_login_button.=' <a href="'.FILENAME_LINKEDIN_APPLICATION.'" title="Sign in with Linkedin"><img class="rounded-12" src="img/linkedin.png" alt="Linkedin"></a>';

 if(MODULE_TWITTER_PLUGIN_JOBSEEKER=='enable' && MODULE_TWITTER_SUBMITTER_OAUTH_CONSUMER_KEY!='')
 $social_login_button.=' <a href="'.FILENAME_TWITTER_APPLICATION.'" title="Sign in with Twitter"><img class="rounded-12" src="img/twitter.png" alt="Twitter"></a>';
}
$social_login_button2='';
if(!check_login("recruiter"))
{
 if(MODULE_FACEBOOK_PLUGIN=='enable' && MODULE_FACEBOOK_PLUGIN_RECRUITER=='enable')
 $social_login_button2.=' <a href="'.FILENAME_FACEBOOK_APPLICATION.'?user_type=recruiter" title="Sign in with Facebook"><img class="rounded-12" src="img/facebook.png" alt="Facebook"></a>';
 if(MODULE_GOOGLE_PLUGIN=='enable' && MODULE_GOOGLE_PLUGIN_RECRUITER=='enable')
 $social_login_button2.=' <a href="'.FILENAME_GOOGLE_APPLICATION.'?user_type=recruiter" title="Sign in with Google"><img class="rounded-12" src="img/google.png" alt="Google"></a>';
 if(MODULE_LINKEDIN_PLUGIN=='enable' && MODULE_LINKEDIN_PLUGIN_RECRUITER=='enable')
 $social_login_button2.=' <a href="'.FILENAME_LINKEDIN_APPLICATION.'?user_type=recruiter" title="Sign in with Linkedin"><img class="rounded-12" src="img/linkedin.png" alt="Linkedin"></a>';
 if( MODULE_TWITTER_PLUGIN_RECRUITER=='enable' && MODULE_TWITTER_SUBMITTER_OAUTH_CONSUMER_KEY!='')
 $social_login_button2.=' <a href="'.FILENAME_TWITTER_APPLICATION.'?user_type=recruiter" title="Sign in with Twitter"><img class="rounded-12" src="img/twitter.png" alt="Twitter"></a>';
}
/////////////////////////////////////////////////////////////////////
if($u==0)
{	$heading_title1=HEADING_TITLE1;
	...
	$area1=''.$form1.
                    ...
                    $FORGOT_PASSWORD1.
                    '</div>
                    <div class="small text-center mt-3 border-login">'.INFO_LOGIN_WITH.'</div>'
                    .$social_login_button.'


                    <div class="small text-center mt-4">'.INFO_NO_ACCOUNT.'</div>'
