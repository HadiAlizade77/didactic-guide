  ...
  case 'back':
   ...
   $sql_data_array['fr_description'] = $fr_description;
    ...
    $messageStack->add(MESSAGE_FR_DESCRIPTION_ERROR, 'error');
     ...
     fclose($handle);
     //french///
					$handle1 = fopen(PATH_TO_MAIN_PHYSICAL.'cron_job/'.PATH_TO_TEMPLATE.'fr_jobseeker_account_alert_template.htm', "w");
...
$template->assign_vars(array(
 ...
 'INFO_TEXT_FR_JOBSEEKER_ACCOUNT_ALERT_DESCRIPTION1'=>tep_draw_textarea_field('fr_description2', 'soft', '', '10', $fr_description, ' id="fr_description2"', true, true),
 'HOST_NAME'                       =>HOST_NAME,
 ...
 else if($action=='preview' || $action=='save' || $action=='insert')
 {
  $template->assign_vars(array(
   ...
   'INFO_TEXT_FR_JOBSEEKER_ACCOUNT_ALERT_DESCRIPTION'=>INFO_TEXT_FR_JOBSEEKER_ACCOUNT_ALERT_DESCRIPTION,
   'INFO_TEXT_FR_JOBSEEKER_ACCOUNT_ALERT_DESCRIPTION1'=>stripslashes($fr_description),
