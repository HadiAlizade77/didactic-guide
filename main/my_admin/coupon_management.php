...
//////**********currency display ***************************/
  ...
  $template->assign_block_vars('gift', array( 'row_selected' => $row_selected,
   ...
   'end_date'     => date("m-d-Y", strtotime($coupon['expired'])),
...
'TABLE_HEADING_COUPON_USAGE'=>TABLE_HEADING_COUPON_USAGE,
 ...
 'new_button'=>'<a class="btn btn-primary float-right" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_COUPONS, 'page=' . $_GET['page'] .'&action=new') . '"><i class="fa fa-plus fa-admin-icons" aria-hidden="true"></i> '.IMAGE_NEW.'</a>',
