...
define('TABLE_HEADING_FR_ZONE_NAME', 'Zones(French)');
...
define('TEXT_INFO_FR_ZONES_NAME', 'Zones Name(French):');
...
define('MESSAGE_SUCCESS_DELETED','Success: Zone Successfully deleted.');
define('MESSAGE_SUCCESS_INSERTED','Success: Zone Successfully inserted.');
define('MESSAGE_SUCCESS_UPDATED','Success: Zone Successfully updated.');

define('MESSAGE_NAME_ERROR','Sorry this zone name already exists.');
