...
***********************************************************
*/
define('HEADING_TITLE','Import Jobs');
define('INFO_TEXT_SUCCESSFULLY_JOBS','successfully jobs :');
define('INFO_TEXT_INSERTED','inserted.');
define('INFO_TEXT_SAMPLE_FILE','<br>CSV (Comma separated values)Select the CSV file in your PC, from browse button and click on Import now button. Ensure that the format is uniform like :<br>Sample File : <a href="'.tep_href_link('admin_jobs.csv').'" target="_blank">Click here to download sample CSV file</a>');

define('INFO_TEXT_IMPORT_JOBS','Import File :');
define('IMAGE_IMPORT_NOW','Import Now');
define('INFO_TEXT_RECRUITER_ID','Recruiter ID');
define('RECRUITER_ID_ERROR','Invalid Recruiter ID.Please check Recruiter ID');
...
define('INFO_TEXT_JOB_APPLY_URL','job_apply_url');
define('INFO_TEXT_JOB_APPLY_URL1','http://example.com/apply_now');
define('INFO_TEXT_JOB_APPLY_URL_DESC','direct apply case give complate url otherwise set to blank');
define('INFO_TEXT_JOB_COMPANY_NAME','job_company_name');
define('INFO_TEXT_JOB_COMPANY_NAME1','Ejobsitesoftware');
define('INFO_TEXT_JOB_COMPANY_NAME_DESC','company name,if blank then default recruiter company name show');
define('INFO_TEXT_JOB_COMPANY_LOGO','job_company_logo');
define('INFO_TEXT_JOB_COMPANY_LOGO1','http://example.com/logo.gif');
define('INFO_TEXT_JOB_COMPANY_LOGO_DESC','company logo complate url,if blank then default recruiter company logo show');
