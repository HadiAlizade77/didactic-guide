  ...
  case 'back':
   ...
   $sql_data_array['description'] = $description;
    ...
    $messageStack->add(MESSAGE_FR_DESCRIPTION_ERROR, 'error');
     ...
     fclose($handle);
     //french
					$handle1 = fopen(PATH_TO_MAIN_PHYSICAL.'cron_job/'.PATH_TO_TEMPLATE.'fr_job_alert_direct_template.htm', "w");
...
$template->assign_vars(array(
 ...
 'INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION1'=>tep_draw_textarea_field('fr_description2', 'soft', '', '10', $fr_description, '   id="fr_description2"', true, true),
 'HOST_NAME'                       =>HOST_NAME,
 ...
 'new_button'=>'<a class="btn btn-primary" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_JOB_ALERT_DIRECT, 'page=' . $_GET['page'] .'&action=new') . '"><i class="fa fa-plus" aria-hidden="true"></i> '.IMAGE_NEW.'</a>',
 ...
 else if($action=='preview' || $action=='save' || $action=='insert')
 {
  $template->assign_vars(array(
   ...
   'INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION'=>INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION,
   'INFO_TEXT_FR_JOB_ALERT_DIRECT_DESCRIPTION1'=>stripslashes($fr_description),
