...
if(empty($action))
{
 ...
 $new_button.='<a class="btn btn-primary" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_CURRENCIES, 'page=' . $_GET['page'] . '&cID=' . $cInfo->currencies_id . '&action=new') . '"><i class="fa fa-plus" aria-hidden="true"></i> ' .IMAGE_NEW_CURRENCY . '</a>';
}
