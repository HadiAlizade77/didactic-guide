...
if($db_recruiter_num_row > 0)
{
 ...
 while ($recruiter = tep_db_fetch_array($db_recruiter_query))
 {
  if($action1!='delete')
  {
   ...
   {
    $status='<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_RECRUITER_PARTICIPATE_JOBFAIR, tep_get_all_get_params(array('jfID','action','selected_box'))).'&rID=' . $recruiter['recruiter_id'] .'&jfID='.$recruiter['id'] .  '&action=recruiter_inactive' . '">' . tep_image(PATH_TO_IMAGE.'icon_status_red_light.gif', STATUS_RECRUITER_INACTIVATE, 30, 20) . '</a>&nbsp;' . tep_image(PATH_TO_IMAGE.'icon_status_green.gif', STATUS_RECRUITER_ACTIVE, 30, 20);
   }
   else
   {
    $status=tep_image(PATH_TO_IMAGE.'icon_status_red.gif', STATUS_RECRUITER_INACTIVE, 30, 20) . '&nbsp;<a href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_RECRUITER_PARTICIPATE_JOBFAIR, tep_get_all_get_params(array('jfID','action','selected_box'))).'&rID=' . $recruiter['recruiter_id'] .'&jfID='.$recruiter['id'] .  '&action=recruiter_active' . '">' . tep_image(PATH_TO_IMAGE.'icon_status_green_light.gif', STATUS_RECRUITER_ACTIVATE, 30, 20) . '</a>';
   }
...
{
 case 'delete':
  $heading[] = array('text' => '<b>' . $rInfo->recruiter_name . '</b>');
 ...
 {
  $heading[] = array('text' => '<b>'.$rInfo->recruiter_name.'</b>');
  $contents[] = array('text' => TEXT_COMPANY."<br><b>".$rInfo->recruiter_company_name.'</b>');
  $contents[] = array('text' => TEXT_INFO_EDIT_ACCOUNT_INTRO);
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_JOBS, 'rID=' . $rInfo->recruiter_id ).'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.IMAGE_JOBS.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ORDERS, 'rID=' . $rInfo->recruiter_id ).'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.IMAGE_ORDERS.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ACCOUNTS, 'plan_for=job_post&rID=' . $rInfo->recruiter_id ).'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.IMAGE_RECRUITER_ACCOUNT_JOB.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_RECRUITER_ACCOUNTS, 'plan_for=resume_search&rID=' . $rInfo->recruiter_id ).'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.IMAGE_RECRUITER_ACCOUNT_RESUME.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION, 'rID=' . $rInfo->recruiter_id ).'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.IMAGE_EDIT.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow1" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_LIST_OF_RECRUITER_PARTICIPATE_JOBFAIR, tep_get_all_get_params(array('rID','selected_box'))).'&rID=' . $rInfo->recruiter_id.'&action=delete'.'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.IMAGE_DELETE.'</a>');
  $contents[] = array('align' => 'left', 'params'=>'class="dataTableRightRow" onmouseover="rowOverEffect(this)" onmouseout="rowOutEffect(this)"','text' => '<a class="list-group-item list-group-item-action" href="' . tep_href_link(FILENAME_RECRUITER_CONTROL_PANEL, 'rID=' . $rInfo->recruiter_id ).'" class="right_black"><i class="fa fa-angle-right" aria-hidden="true"></i> '.INFO_TEXT_RECRUITER_CONTROL_PANEL.'</a>');
...
'TABLE_HEADING_NO_OF_JOBFAIR_JOBS'=>TABLE_HEADING_NO_OF_JOBFAIR_JOBS,
 ...
 'new_button'=>'<a class="btn btn-primary" href="' . tep_href_link(FILENAME_RECRUITER_REGISTRATION, 'add=recruiter') . '"><i class="fa fa-plus fa-admin-icons" aria-hidden="true"></i> ' .IMAGE_NEW . '</a>',
  ));
}
$template->assign_vars(array(
