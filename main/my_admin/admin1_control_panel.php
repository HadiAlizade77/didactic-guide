...
$template->assign_vars(array(
 ...
 'button'=>'<input class="btn btn-primary" type="submit" name="report" value="Go">',
...
$latest_employers='<table class="table table-hover">';
...
$latest_employers.='<tr><td>'.$recruiter_logo.'</td><td>'.$row['recruiter_company_name'].'<br>'.$row['recruiter_email_address'].'</td>
					<td>'.date("m-d-Y", strtotime($row['inserted'])).'</td></tr>';
...
$latest_jobseekers.='<tr><td>'.$photo.'</td><td>'.$name.'<br>'.$rowjb['jobseeker_email_address'].'</td>
					<td>'.date("m-d-Y", strtotime($rowjb['inserted'])).'</td></tr>';
