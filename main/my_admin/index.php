...
$template->assign_vars(array(
 ...
 'TEXT_INFO_USER_NAME1'=>tep_draw_input_field('TR_User_Name','','class="form-control form-control-sm" placeholder="username"',false),
 'TEXT_INFO_PASSWORD'=>TEXT_INFO_PASSWORD,
 'TEXT_INFO_PASSWORD1'=>tep_draw_password_field('TR_Password','',false,'class="form-control form-control-sm" placeholder="password"'),
 ...
 'new_button'=>'<button type="submit" class="btn btn-primary btn-xl">Login</button>',//tep_image_submit(PATH_TO_BUTTON.'button_confirm.gif', IMAGE_CONFIRM),
