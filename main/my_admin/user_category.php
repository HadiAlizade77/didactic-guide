...
$template->assign_vars(array(
 ...
 'new_button'=>'<a class="btn btn-primary float-right" href="' . tep_href_link(PATH_TO_ADMIN.FILENAME_ADMIN1_ADMIN_USER_CATEGORY, 'page=' . $_GET['page'] .'&action=new') . '"><i class="fa fa-bars fa-plus" aria-hidden="true"></i> '.IMAGE_NEW.'</a>',
