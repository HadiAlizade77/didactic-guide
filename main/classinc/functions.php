                         ...
                         $startYear="", $endYear="", $required=false,$display_name=false)
{
	...
	$datelist.= '<div class="row"><div class="col-md-4 pr-0"><select '.$day_parameter.'><option value="">'.INFO_TEXT_DAY.'</option>';
	$ct=0;
	for($ct=1;$ct<=31;$ct++)
	{
		if(strlen($ct)<2)
	...
	$datelist.="</select></div>";
	// $datelist.=" - ";
	$datelist.='<div class="col-md-4 pr-0"><select '.$month_parameter.'><option value="">'.INFO_TEXT_MONTH1.'</option>';
	$ct=1;
 $month_array=array("01"=>INFO_TEXT_JANUARY,"02"=>INFO_TEXT_FEBRUARY,"03"=>INFO_TEXT_MARCH,
	...
	$datelist.='</select></div>';
	// $datelist.="-";
	$datelist.= '<div class="col-md-4"><select '.$year_parameter.'><option value="">'.INFO_TEXT_YEAR1.'</option>';
	$ct=0;
	if($startYear=="")
	{
		$s_yy=(date('Y')-80);
