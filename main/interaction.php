...
else
{
 ...
 {
   $show='<a href="'.tep_href_link(FILENAME_EMPLOYER_INTERACTION,'view=inbox&query_string='.$query_string).'">Inbox</a> | <a href="'.tep_href_link(FILENAME_RECRUITER_ATS_MAILS,'query_string='.$query_string).'">All Jobseeker Mails</a>';
