...
define('TABLE_HEADING_DATE_OF_APPLICATION','Applied on');
define('TABLE_HEADING_APPL_ACTION','Action');
define('TABLE_HEADING_APPL_EDIT_STATUS','Status');

define('INFO_TEXT_APP_TRACK','Applicant Pipeline');
define('INFO_TEXT_EDIT','Edit');
define('INFO_TEXT_SHORTL','Shortlisted');
define('INFO_TEXT_SELECT','Select');
define('INFO_TEXT_CONTACT','Contact');
define('INFO_TEXT_VIEW_RES','View Resume');
define('INFO_TEXT_SEL_CAND','Selected Candidates');
define('INFO_ALL_APP','All Applicants');
define('INFO_ALL_SEL_APP','Selected Applicants');
