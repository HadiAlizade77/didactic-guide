...
define('HEADING_TITLE','Education Section');

define('TABLE_HEADING_INSTITUTION_NAME','Institution Name');
define('TABLE_HEADING_DEGREE','Degree');
define('TABLE_HEADING_DEGREE_OBT_DATE','Start Date');
define('TABLE_HEADING_DEGREE_END_DATE','End Date');
...
define('INFO_TEXT_SPECIALIZATION','Specialization :');
...
define('MESSAGE_DEGREE_START_DATE_ERROR','Degree Start Date is not in required format.');
define('MESSAGE_DEGREE_END_DATE_ERROR','Degree End Date is not in required format.');
define('MESSAGE_DEGREE_DATE_ERROR','Degree Start Date must be earlier than End Date');
...
define('MESSAGE_SUCCESS_REORDER','Success : Record successfully Reorder.');
