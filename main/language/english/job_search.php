...
{
 define('HEADING_TITLE','Jobs');
 define('INFO_TEXT_JOB_CATEGORY','Job Category :');

}
else
{
 define('HEADING_TITLE','Search Jobs');
 define('INFO_TEXT_JOB_CATEGORY','Job Category :');
}
...
define('INFO_TEXT_POSTED_ON','Posted:');
define('INFO_TEXT_SALARY','Salary');
define('INFO_TEXT_SALARY_DOT',':');
define('INFO_TEXT_APPLY_BEFORE','Ends :');
define('INFO_TEXT_JOB_SKILL','Job Skills');

define('INFO_TEXT_TITLE_NAME','Search name: ');
...
define('INFO_TEXT_TO_YOUR_SEARCH_CRITERIA','Jobs Found.');
...
define('INFO_EXPERIENCE','Any experience');
define('INFO_TEXT_SAVE_JOB','Save Job');
define('INFO_TEXT_JOB_SAVED','Saved');
define('INFO_TEXT_JOB_SALARY','Salary :');

define('INFO_TEXT_CREATE_JOB_ALERT',' Create job alert');

/*place holders*/
define('INFO_P_EXP','');
define('INFO_ALL_COUNTRY','All countries');
define('INFO_P_ANY_SAL','Any Salary');
define('INFO_P_ALL_JOB_TYPE','All Types');
define('INFO_BUTTON_SEARCH','Search');
define('INFO_APPLY_SELECTED','Apply Selected Jobs');
define('INFO_REG_USER','Registered User');
define('INFO_NEW_USER','New User');
?>