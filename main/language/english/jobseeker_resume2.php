...
define('HEADING_TITLE','Work Experience');

define('TABLE_HEADING_START_DATE','Start Date');
define('TABLE_HEADING_END_DATE','End Date');
...
define('SECTION_WORK_EXPERIENCE','Total Work Experience');

define('INFO_TEXT_RESUME_NAME','Resume name :');
define('INFO_TEXT_EXPERIENCE','Total Experience :');
define('INFO_TEXT_FRESHER','I don\'t have any work experience :');
define('INFO_TEXT_COMPANY','Company Name :');
...
define('INFO_TEXT_SALARY','Salary/Wage :');

define('INFO_TEXT_COMPANY_INDUSTRY','Job Category :');
define('INFO_TEXT_START_DATE','Start Date :');
define('INFO_TEXT_END_DATE','End Date :');
define('INFO_TEXT_STILL_WORK','Still Working');
define('INFO_TEXT_TILL_DATE','Current');

define('INFO_TEXT_DESCRIPTION','Describe work experience:');

define('MESSAGE_START_DATE_ERROR','Start Date is not in required format.');
define('MESSAGE_END_DATE_ERROR','End Date is not in required format.');
define('MESSAGE_DATE_ERROR','Start Date must be earlier than End Date');
define('MESSAGE_SAME_DATE_ERROR','Start Date can not be same as End Date');
define('MESSAGE_COMPANY_ERROR','Please enter Company.');
define('MESSAGE_VESSEL_ERROR','Please enter Phone No.');
define('MESSAGE_STATE_ERROR','Please select State.');
define('MESSAGE_COUNTRY_ERROR','Please select country.');
define('MESSAGE_JOB_TITLE_ERROR','Please enter Job Title');

define('ENTRY_STATE_ERROR_SELECT', 'Please select a state from the States pull down menu.');
define('ENTRY_STATE_ERROR', 'Please enter State.');
