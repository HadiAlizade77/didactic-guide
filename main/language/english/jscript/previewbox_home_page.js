          ...
          var card = `
							...
							<section class="two-pane-serp-page__detail-view for-mobile" style="height: calc(100vh - 69px);">
								<div class="card card-custom" id="sticky">
									...
									<div class="job-preview-img"><img class="img-fluid" src="${
										data[0].logoPath
									  }"></div>
									</div>
				...
				<i class="bi bi-linkedin text-linkedin"></i> Linkedin</a>
								  ...
								  -->
										...
										<h5 class="pb-2 preview-title">Job Summary</h5>
										<div class="card-text">
											${data[0].job_short_description}	
										</div>
										<h5 class="pt-3 pb-2 preview-title">Job Description</h5>
										<div class="card-text">
											${data[0].job_description}
										</div>
										<h5 class="pt-3 mb-3 preview-title">Keyskills</h5>
						`;
          card +=
