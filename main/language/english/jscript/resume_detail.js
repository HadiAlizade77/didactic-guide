				...
				<div class="card card-custom" id="sticky">
						...
						<div class="d-flex" style="margin-top:-210px;">
							<div class="flex-shrink-0">
								<div class="resume-pic">
									<img class="img-fluid" id="userProfileImg" src="${profile_img}">
								</div>
							</div>
							<div class="flex-grow-1 ms-3">
								<div class="">
									<h4 class="m-0 fw-bold" style="font-size:24px;">
                    ...
                    user_email
                      ...
                      : ""
									...
									<div class="">${
                    phone && '<i class="bi bi-telephone me-2"></i> ' + phone
                  }</div>
									<div class="">${
                    address && '<i class="bi bi-geo-alt me-2"></i> ' + address
						...
						<hr style="margin:20px -25px 18px -25px;">
						<!-- Basic Info and Social Profile Starts -->
						<div class="row">
							<div class="col-md-6">
								<h3 class="mb-3" style="font-size:18px;font-weight:bold;">Basic Info</h3>
								<div class="table-responsive-sm">
                                    ${
                                      target_job ?
                                      `
                                        <div>
                                            <div class="fw-bold">Target Job </div>
                                            <div><span class="right-title-resume">${target_job}</span></div>
                                        </div>
                                        ` : ''
                                    }
                                    ...
                                    ${
                                      ...
                                      `
                                        <div>
                                            <div class="fw-bold mt-2">Job Type </div>
                                            <div><span class="right-title-resume"> ${job_type}</span>
                                            </div>
                                        </div>
                                        ` : ''
                                    }
                                    ...
                                    ${
                                      ...
                                      `
                                        <div>
                                            <div class="fw-bold mt-2">Job Category </div>
                                            <div><span class="right-title-resume"> ${job_category}</span></div>
                                        </div>
                                        ` : ''
                                    }
                                    ...
                                    ${
                                      ...
                                      `
                                        <div>
                                            <div class="fw-bold mt-2">Desired Salary/Wage </div>
                                            <div><span class="right-title-resume"> ${salary}</span></div>
                                        </div>
                                        ` : ''
                                    }
                                    ...
                                    ${
                                      ...
                                      `
                                        <div>
                                            <div class="fw-bold mt-2">Willing to relocate </div>
                                            <div><span class="right-title-resume"> ${relocate}</span></div>
                                        </div>
                                        ` : ''
                                    }
							...
							<div class="col-md-6">
                                ${
                                  (facebook_url ||
                                    ...
                                    twitter_url) ?
                                  `
								<h3 class="mb-3" style="font-size:18px;font-weight:bold;">Social Profile</h3>
								<div class="table-responsive-sm">
                                    ${
                                      facebook_url ?
                                      `
						...
						<hr style="margin:20px -25px 18px -25px;">
						<div>
							<h3 class="mb-2" style="font-size:24px;font-weight:bold;">Objective </h3>
                        ...
                        <hr style="margin:20px -25px 18px -25px;">
						<div>
                            <div class="mb-2" style="font-size:24px;font-weight:bold;">Education</div>
                            ${educationDetail}
                        </div>
                        ` : ''
                        }
						...
						<hr style="margin:20px -25px 18px -25px;">
						<div>
							<div class="mb-2 resume-heading" style="font-size:24px;font-weight:bold;">Skills</div>
							<div class="row">
								${userSkills}
							</div>
						</div>
                        ...
                        <hr style="margin:20px -25px 18px -25px;">
                        <div class="">
                            <h3 class="resume-heading" style="font-size:24px;font-weight:bold;">Reference Details</h3>
                            <div class="row">
                                    ${userReferences}
                            </div>
                        </div>
						...
						<hr style="margin:20px -25px 18px -25px;">
						<div class="">
							<h3 class="resume-heading" style="font-size:24px;font-weight:bold;">Languages</h3>
							<div class="table-responsive-sm">
								${userKnowLang}
							</div>
						</div>
						...
						<hr style="margin:20px -25px 18px -25px;">
						<div class="">
							<h3 class="resume-heading" style="font-size:24px;font-weight:bold;">Video Resume</h3>
                        ...
                        ${
                          ...
                          `
                            <hr style="margin:20px -25px 18px -25px;">
                            <div class="mb-5">
                                <h3 class="resume-heading" style="font-size:24px;font-weight:bold;margin-bottom:20px;">
                                    Pasted Resume</h3>
                                <div class="mb-5">
