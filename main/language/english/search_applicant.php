...
define('INFO_APP_SEARCH','Search Applicants');
define('INFO_APPLICATION_ID','Application ID');
define('INFO_FIRST_NAME','First Name');
define('INFO_LAST_NAME','Last Name');
define('INFO_ANY_EXP','Any Experience');
define('INFO_TEXT_SEARCH_APPLICANTS','Search Applicants');
define('INFO_TEXT_CR_APP',' Current Applicants');
define('INFO_TEXT_MATCHED','Matched ');
define('INFO_ALL_APPLICANTS','Applicants Result');
?>