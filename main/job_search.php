...
if(tep_not_null($action))
{
 switch($action)
 {
  case 'search':
   ...
   if(tep_not_null($keyword)  && (($_POST['keyword']!='keyword') && ($_POST['keyword']!='job search keywords')) ) //   keyword starts //////
   {
    ...
    $search_string.='<div class="tags"><div class="tag">'.tep_db_output($keyword).'
      <a href="#sf_keyword" class="search_fiter tag__name" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
   ...
   if(tep_not_null($_POST['job_post_day']))
   {
    ...
    if($job_post_day>0)
    {
      ...
      $search_string.='<div class="tags"><div class="tag">'.tep_db_output($posted_array[$job_post_day]).' <a href="#sf_job_post_day_'.$job_post_day.'" class="search_fiter tag__name" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
      <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
    </svg></a></div></div>';
      }
    $whereClause=(tep_not_null($whereClause)?$whereClause.' and ':'');
   ...
   if(tep_not_null($_POST['job_type']))
   {
    ...
    $search_string.='<div class="tags"><div class="tag">'.tep_db_output($job_typeName).' <a href="#sf_job_type" class="search_fiter tag__name" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
    <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
  </svg></a></div></div>';
   }
   // job type end //
   ...
   if(tep_not_null($_POST['experience']))
   {
    ...
    $search_string.='<div class="tags"><div class="tag">
      ...
      <a href="#sf_experience" class="search_fiter tag__name"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
      <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
    </svg></a></div></div>';
  }
   //*/// experience ends ///
  ...
  if(tep_not_null($_POST['skillTag'])){
    ...
    $search_string.='<div class="tags"><div class="tag">
      '.$job_skill.'
      <a href="#sf_skills" class="search_fiter tag__name" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
      <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
    </svg></a></div></div>';
  }
  ...
  if(is_array($_POST['salary_range']))
{
   ...
   foreach($salary_range as  $key)
 {
   ...
   $search_string.='<div class="tags"><div class="tag">'.getSalaryRangeName($key).' <a href="#sf_job_salary_'.$key.'" class="search_fiter tag__name" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
   <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
 </svg></a></div></div>';
 ...
 //salary range end
   ...
   {
    $search_string.='<div class="tags"><div class="tag">'.tep_db_output($state).' <a href="#sf_job_state" class="search_fiter tag__name" ><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
    <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
  </svg></a></div></div>';
   ...
   //////////////////
			$query = "select $field_names from $table_names where $whereClause ORDER BY if(j.job_source ='jobsite',0,1)  asc, j.job_featured='Yes' desc, j.inserted desc";
			$starting=0;
...
//////**********currency display ***************************/
     $save_job    ='<div id="'.$query_string.'"  class="nav-item" ><a class="small" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'" title="'.INFO_TEXT_SAVE_JOB.'"><i class="fa fa-heart-o icon-unsaved mobile-absolute-right"></i><!-- '.INFO_TEXT_SAVE_JOB.'--></a></div>';
...
$template->assign_block_vars('job_search_result', array(
        ...
        'jobId' => $row['job_id'],
			'description' => nl2br(tep_db_output(strip_tags(substr($row['job_short_description'],0,100).'. . .'))),
			  'apply_before' => date("m-d-Y", strtotime($row['expired'])),
			  'posted_on' => date("m-d-Y", strtotime($row['inserted'])),
			  'logo'      => $recruiter_logo,
			  'email_job' => $email_job,
			  'save_job'  => $save_job,
			  'apply_job' => (($row_apply['id']>0 && $row_apply['jobseeker_apply_status']='active')?'  <span class="btn btn-sm btn-success btn-block"><i class="fa fa-check" aria-hidden="true"></i> Applied</span>':$apply_job),
...
if($action!='search')
{
 $template->assign_vars(array( 'hidden_fields' => $hidden_fields,
  ...
  'INFO_TEXT_KEYWORD1'     => tep_draw_input_field('keyword', $keyword, 'placeholder="'.INFO_P_EXP.'" class="form-control"'),
  ...
  'INFO_TEXT_LOCATION1'    => (($search_zip_code==2)?tep_draw_input_field('zip_code',$zip_code,'').''.zone_radius('radius',"","",$radius,true,"class='form-control'").tep_draw_hidden_field('location',''):tep_draw_input_field('location', $location,' class="form-control" ',false)),
...
//  'INFO_TEXT_ZIP_CODE1'    => tep_draw_input_field('zip_code',$zip_code,' class="form-control" '),
...
{$key1=(tep_not_null($keyword)?$key1=$keyword:'keyword');
 ...
 $template->assign_vars(array( 'hidden_fields' => $hidden_fields,
  ...
  'INFO_TEXT_APPLY_NOW1'   => (($x>0)
                                ? '<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16"
                                      fill="currentColor" class="bi bi-arrow-90deg-down mt-1" viewBox="0 0 16 16">
 ...
 'INFO_TEXT_APPLY_BUTTON' => (($x>0)?(check_login("jobseeker")?'<a class="btn btn-primary" onclick="ckeck_application(\'\');" role="button">'.INFO_APPLY_SELECTED.'</a>':'<a class="btn btn-primary me-3" href="'.tep_href_link(FILENAME_JOBSEEKER_LOGIN).'">'.INFO_REG_USER.'</a><a class="btn btn-outline-primary" href="'.tep_href_link(FILENAME_JOBSEEKER_REGISTER1).'">'.INFO_NEW_USER.'</a>'):''),
...
// 'INFO_TEXT_ALERT_SAVE'   => (($action1=='save_search')
  ...
  .($action1=='save_search'?'<a href="'.tep_href_link(FILENAME_JOBSEEKER_LIST_OF_SAVED_SEARCHES).'" class="btn btn-sm btn-outline-primary me-2"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-x text-white" viewBox="0 0 16 16">
  <path d="M4.646 4.646a.5.5 0 0 1 .708 0L8 7.293l2.646-2.647a.5.5 0 0 1 .708.708L8.707 8l2.647 2.646a.5.5 0 0 1-.708.708L8 8.707l-2.646 2.647a.5.5 0 0 1-.708-.708L7.293 8 4.646 5.354a.5.5 0 0 1 0-.708z"/>
</svg></a>':'')
