...
if ($no_of_job > 0) {
	...
	<div class="card card-jobseeker mb-3">
				...
				<table   background="img/line1.gif" border="0"  width="95%" align="center" bgcolor="#ffffff"  cellspacing="0" cellpadding="3">
				<tr height="130">
   ...
   <div class="card card-jobseeker mb-3">
                <div class="card-body p-0 pb-3">
				<div class="card-header card-header-custom px-4 pt-3" style="border-top-left-radius:0.8rem;border-top-right-radius:0.8rem;">Applicant Pipeline</div>
		<table class="table-responsive" background="img/line1.gif" border="0"  width="95%" align="center" bgcolor="#ffffff"  cellspacing="0" cellpadding="3">
			<tr height="130">
			...
			<tr bgcolor="#ffffff" class="small">
				<td align="center"  class=""><b>' . INFO_TOTAL . '</b></td>
...
if (tep_not_null($row_contact['recruiter_logo']) && is_file(PATH_TO_MAIN_PHYSICAL_LOGO . $row_contact['recruiter_logo'])) {
	...
	$logo = '<div class="no-pic mx-auto">' . $logo . '</div>
    ';
} else {
	$logo = '<div>
...
$template->assign_vars(array(
	...
	'INFO_TEXT_POST_JOB'        => '<a href="' . tep_href_link(FILENAME_RECRUITER_POST_JOB) . '" title="' . INFO_TEXT_POST_JOB . '" class="customClass style39">' . INFO_TEXT_POST_JOB . '</a>',
...
' . INFO_TEXT_APPLY_WITHOUT_LOGIN . ' <label for="checkbox_rec_dr_log" class="switch">' . tep_draw_checkbox_field('direct_login', 'Yes', '', $direct_login, ' class="inputdemo" id="checkbox_rec_dr_log" onchange="this.form.submit();"') . '<span class="slider round"></span></label></form>',
	...
	<i class="bi bi-cart"></i>&nbsp;Rate Card
                                              </a>',
