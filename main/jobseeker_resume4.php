...
{
 $query_string=encode_string("resume_id@@@".$resume_id."@@@resume");
 $skills_button='<button class="btn btn-primary me-2" type="submit">Save</button>';//tep_image_submit(PATH_TO_BUTTON.'button_save.gif', IMAGE_SAVE,"");
 ...
 $languages_button='<button class="btn btn-primary me-2" type="submit">Save</button>';//tep_image_submit(PATH_TO_BUTTON.'button_save.gif', IMAGE_SAVE,"");
 ...
 if($_POST['action']=="edit_skills" || $_POST['action']=="add_skills")
 {
  if($_POST['action']=="edit_skills")
  {
   ...
   $skills_button     = '<button class="btn btn-outline-secondary px-4 me-2" type="submit">Update</button>';//tep_image_submit(PATH_TO_BUTTON.'button_update.gif', IMAGE_UPDATE);
  ...
  {
  $query_string=encode_string("resume_id@@@".$resume_id."@@@resume");
  $skills_button = '<button class="btn btn-primary me-2" type="submit" onclick=set_action("add_skills")>Save</button>';//tep_image_submit(PATH_TO_BUTTON.'button_save.gif', IMAGE_SAVE_ADD_NEW," onclick=set_action('add_skills')");
  $skills_form=tep_draw_form('skills', FILENAME_JOBSEEKER_RESUME4, '', 'post', 'onsubmit="return ValidateForm(this)" ').tep_draw_hidden_field('query_string',$query_string).tep_draw_hidden_field('action','add_skills');
  }
 }
 elseif($_POST['action']=="edit_languages" || $_POST['action']=="add_languages")
 {
  if($_POST['action']=="edit_languages")
  {
   ...
   $proficiency         = $proficiency;
   $query_string=encode_string("resume_id@@@".$_POST['resume_id']."@@@resume");
   $languages_button     = '<button class="btn btn-outline-secondary px-4 me-2" type="submit">Update</button>';//tep_image_submit(PATH_TO_BUTTON.'button_update.gif', IMAGE_UPDATE);
  ...
  {
   $query_string=encode_string("resume_id@@@".$resume_id."@@@resume");
   $languages_button = '<button class="btn btn-primary me-2" type="submit" onclick=set_action1("add_languages")>Save</button>';//tep_image_submit(PATH_TO_BUTTON.'button_save.gif', IMAGE_SAVE_ADD_NEW," onclick=set_action1('add_languages')");
   $languages_form=tep_draw_form('languages', FILENAME_JOBSEEKER_RESUME4, '', 'post', 'onsubmit="return ValidateForm(this)" ').tep_draw_hidden_field('query_string',$query_string).tep_draw_hidden_field('action','add_languages');
  }
 }
}
else
{
 ...
 /*********************************************************/
$query_string       = encode_string("resume_id@@@".$resume_id."@@@resume");
$add_next_button    = "<a href='".tep_href_link(FILENAME_JOBSEEKER_RESUME5."?query_string=".$query_string)."' class='btn btn-outline-secondary'>".tep_db_output(INFO_SKIP_THIS_STEP)."</a>";
...
$add_next_button1    = "<a class='btn btn-outline-secondary px-4 me-2' href='".tep_href_link(FILENAME_JOBSEEKER_RESUME5."?query_string=".$query_string)."' >Next Page</a>";
